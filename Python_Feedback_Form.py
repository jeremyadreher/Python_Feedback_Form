...
class Feedback:
    ...
    def __init__(self, master):
        ...
        self.style.configure('TButton', background = '#e1d8b0')
        self.style.configure('TLabel', background = '#e1d8b0', font = ('Arial', 11))
        ...
        self.logo = PhotoImage(file = '/Users/Development/Desktop/Python Item 49/Ex_Files_Python_Tkinter/Exercise Files/Ch08/tour_logo.gif')
